              ...
              <div className="p-6">
                ...
                <div className="flex flex-col items-center mb-4">
                  <div className="relative mb-2">
                    ...
                    <div
                      className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full flex items-center justify-center font-bold text-white text-sm shadow-lg border-2 border-white"
                      style={{
                  ...
                  {driver.country_code && (
                    <img
                      ...
                      className="w-10 h-6 rounded shadow mb-2"
                      onError={(e) => {
                        e.target.style.display = 'none';
                      }}
                    />
