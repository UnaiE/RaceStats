        ...
        try:
            ...
            if race_date:
                ...
                try:
                    ...
                    # Si la carrera es en más de 14 días, usar forecast; si no, usar history para fechas pasadas
                    if days_until_race > 14:
                        print(f"⚠️ Carrera muy lejana ({days_until_race} días), usando forecast general")
